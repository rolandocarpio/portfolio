...
> _"Booting Pip-OS® version 2.0.25_
...
* Interactive Navigation
  ...
  Smooth page transitions and immersive interface feedback powered by React Router.
* Weather & Time Widgets

  Dynamic weather and real-time clock elements styled to fit the terminal theme.
* Clean Component Architecture

  Fully modularized React components (Scree, Border, Battery, Footer, etc.) for maintainability and scalability.
* Responsive Design
...
**2. Initialize Frontend System**

cd client  
npm install  
npm run dev

**3. Activate Backend Relay**
